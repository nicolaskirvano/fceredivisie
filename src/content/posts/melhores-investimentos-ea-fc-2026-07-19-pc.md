---
author: "FutQuant"
pubDatetime: 2026-07-19T10:36:18.000Z
title: "Investimentos EA FC: Eredivisie em 19/07 — PC"
draft: false
featured: true
tags:
  - investimentos
...
faq:
  - q: "Qual a melhor carta para investir hoje (19/07/2026) no EA FC?"
    a: "Mika Godts (87, Eredivisie) lidera, com +31.3% em 7 dias a 30k coins no PC. A lista mede momentum e deve ser confirmada com uma cotação atual antes da compra."
...
> 🔝 **Destaque:** Mika Godts (87) acumula **+31.3% em 7 dias** a 30k coins; leitura atual: **momentum moderado**.

![Gráfico de variação em 7 dias para os destaques de Investimentos EA FC: Eredivisie em 19/07 — PC](/charts/melhores-investimentos-ea-fc-2026-07-19-pc.svg)
...
- A mediana é de **+12.5% em 24h** e **+12.3% em 7 dias**.
...
| --- | --- | --- | --- | --- | --- | --- |
| Mika Godts | 87 | Eredivisie | 30k coins | +2.4% | +31.3% | Momentum moderado |
| Givairo Read | 86 | Eredivisie | 22k coins | +22.7% | +15% | Esticada |
| Ayase Ueda | 84 | Eredivisie | 42k coins | +2.4% | +9.7% | Entrada a observar |
| Wout Weghorst | 85 | Eredivisie | 82k coins | +23.5% | +7.9% | Esticada |


## 📈 Análise dos destaques

- **Mika Godts (87)** — 30k coins, **+31.3% em 7 dias** (+2.4% em 24h). Preço +32% acima da média de 7 dias (aquecida). Sem previsão recente válida; acompanhe preço e liquidez para escolher a entrada.

- **Givairo Read (86)** — 22k coins, **+15% em 7 dias** (+22.7% em 24h). Preço em linha com a média de 7 dias (-5%). Sem previsão recente válida; acompanhe preço e liquidez para escolher a entrada.

- **Ayase Ueda (84)** — 42k coins, **+9.7% em 7 dias** (+2.4% em 24h). Preço em linha com a média de 7 dias (+6%). Sem previsão recente válida; acompanhe preço e liquidez para escolher a entrada.

- **Wout Weghorst (85)** — 82k coins, **+7.9% em 7 dias** (+23.5% em 24h). Preço +10% acima da média de 7 dias (aquecida). Sem previsão recente válida; acompanhe preço e liquidez para escolher a entrada.
...
Mika Godts (87, Eredivisie) lidera, com +31.3% em 7 dias a 30k coins no PC. A lista mede momentum e deve ser confirmada com uma cotação atual antes da compra.
...
- [Mercado EA FC em 19/07: Eredivisie — PC](/posts/mercado-ea-fc-2026-07-19-pc/)
