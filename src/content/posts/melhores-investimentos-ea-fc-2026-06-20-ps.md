...
title: "Momentum de Eredivisie no EA FC em 20/06 — PS"
draft: false
featured: true
tags:
  - investimentos
  ...
  - previsoes
  - ps
description: "Ranking histórico de momentum em 20/06/2026 no PS: Can Bozdoğan liderou 7d com +51,5%. Compare preços, 24h/7d, gráfico e limites."
---
...
**Can Bozdoğan** liderou o recorte com **+51,5% em 7d** e +6,4% em 24h. Entre 4 cartas, 4 tinham as duas janelas positivas; a mediana semanal foi **+50,0%**.

Os preços destacados iam de **18.000 coins** a **29k coins**. O ranking descreve momentum observado naquela data; previsão ausente ou inválida aparece como N/D e não confirma uma compra atual.

![Gráfico de variação em 7 dias para os destaques de Momentum de Eredivisie no EA FC em 20/06 — PS](/charts/melhores-investimentos-ea-fc-2026-06-20-ps.svg)
...
- **Can Bozdoğan (87)** — 18k coins, **+51.5% em 7 dias** (+6.4% em 24h). Preço -27% abaixo da média de 7 dias (descontada). O dado registrava momentum positivo; uma entrada atual exige nova validação.

- **Ivan Perišić (86)** — 28k coins, **+50.5% em 7 dias** (+30.5% em 24h). Preço +17% acima da média de 7 dias (aquecida). O dado registrava momentum positivo; uma entrada atual exige nova validação.
...
Can Bozdoğan (87, Eredivisie) lidera, com +51.5% em 7 dias a 18k coins no Console (PS). No recorte, isso descrevia momentum observado, não uma recomendação atual.
...
- [Eredivisie no EA FC em 20/06: altas e baixas — PS](/posts/mercado-ea-fc-2026-06-20-ps/)
